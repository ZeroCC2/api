...
import (
	...
	"github.com/lonelyshoeh/api/internal/migration"
	defaultresolver "github.com/lonelyshoeh/api/internal/resolvers/default"
	"github.com/lonelyshoeh/api/internal/twitchapiclient"
...
// if bug described in https://github.com/lonelyshoeh/api/pull/422 is fixed
